...
import { Plus, Zap, Settings, Command, ShieldCheck, Globe } from 'lucide-react';
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center animate-in fade-in zoom-in duration-1000 relative overflow-hidden">
      ...
      <div className="space-y-4 mb-16">
        <h1 className="text-5xl md:text-6xl font-bold text-zinc-900 dark:text-white tracking-tighter transition-colors duration-300">
          Intelligence, <span className="bg-gradient-to-r from-indigo-400 to-teal-400 bg-clip-text text-transparent">Unchained.</span>
        </h1>
        <p className="max-w-xl mx-auto text-zinc-500 dark:text-zinc-400 text-lg md:text-xl font-medium leading-relaxed transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-2xl">
        <button 
          ...
          className="flex flex-col items-start p-6 rounded-[2rem] glass hover:bg-black/[0.02] dark:hover:bg-white/[0.04] border-black/5 dark:border-white/5 hover:border-indigo-500/30 transition-all group text-left"
        >
          ...
          <h3 className="text-zinc-900 dark:text-white text-lg font-bold mb-1">New Session</h3>
        ...
        <button 
          ...
          className="flex flex-col items-start p-6 rounded-[2rem] glass hover:bg-black/[0.02] dark:hover:bg-white/[0.04] border-black/5 dark:border-white/5 hover:border-teal-500/30 transition-all group text-left"
        >
          ...
          <h3 className="text-zinc-900 dark:text-white text-lg font-bold mb-1">Engine Control</h3>
      ...
      <div className="mt-20 flex flex-wrap items-center justify-center gap-8 opacity-40 grayscale hover:grayscale-0 transition-all duration-500">
        <div className="flex items-center gap-2 text-xs font-bold text-zinc-500 dark:text-zinc-400 tracking-widest uppercase">
      ...
      {!isConnected && (
        <div className="absolute top-8 px-6 py-2.5 rounded-full glass-strong border-rose-500/30 text-rose-400 text-[10px] font-bold tracking-[0.2em] animate-pulse flex items-center gap-3">
